...
<div id="app" class="h-screen flex flex-col overflow-hidden">
	...
	<nav class="h-16 flex flex-none items-center justify-center border-b">
		...
		<div class="flex-grow p-2 text-xl"></div>
	...
	<div class="flex-1 flex overflow-hidden">
		...
		<div class="flex-1 flex">
			<div class="px-6 py-4 flex-1 overflow-y-auto relative">
				<div style="opacity: {$navigating ? 100 : 0}; display: {$navigating ? 'block' : 'none'};" class="absolute top-0 left-0 w-full h-full flex justify-center content-end p-10 transition-opacity duration-300 delay-200 ease-in">
